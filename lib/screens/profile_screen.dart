...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final postsCount = (userData!['posts'] is List)
        ? (userData!['posts'] as List).length
        : (userData!['posts'] ?? 0);

    final eventsCount = (userData!['events'] is List)
        ? (userData!['events'] as List).length
        : (userData!['events'] ?? 0);

    final friendsCount = (userData!['friends'] is List)
